...
function EditDocReglement(props) {
    ...
    const updateDatas = () => {
        ...
        axios
          .patch(`${baseURL}/doc-regl/${id}/`, data, {
            /*headers: {
              headers,
            },*/
          })
    ...
    return(
        ...
        >
            ...
            <DialogContent>
                ...
                <TextField value={datas.dr_type_regl} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_type_regl'} label={'dr_type_regl'} variant={'outlined'} color={'secondary'}></TextField>
                <TextField value={datas.dr_date} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_date'} label={'dr_date'} defaultValue={defaultDate} variant={'outlined'} color={'secondary'}></TextField>
                <TextField value={datas.dr_libelle} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_libelle'} label={'dr_libelle'} variant={'outlined'} color={'secondary'}></TextField>
                <TextField value={datas.dr_pourcent} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_pourcent'} label={'dr_pourcent'} variant={'outlined'} color={'secondary'}></TextField>
                <TextField value={datas.dr_montant} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_montant'} label={'dr_montant'} variant={'outlined'} color={'secondary'}></TextField>
                <TextField value={datas.dr_montant_dev} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_montant_dev'} label={'dr_montant_dev'} variant={'outlined'} color={'secondary'}></TextField>
                <TextField value={datas.dr_equil} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_equil'} label={'dr_equil'} variant={'outlined'} color={'secondary'}></TextField>
                ...
                <TextField value={datas.dr_regle} onChange={handleDataChange} sx={{width: '80%', margin: '10px'}} size={'small'} name={'dr_regle'} label={'dr_regle'} variant={'outlined'} color={'secondary'}></TextField>
...
export default EditDocReglement