...
function EditPlanEntretienGarage(props) {
    ...
    const retrieveDatas = () => {
        axios
          .get(`${baseURL}/plan-entretien-garage/${id}/`, {
            /*headers: {
              headers,
            },*/
          })
    ...
    const updateDatas = () => {
        ...
        axios
          .patch(`${baseURL}/plan-entretien-garage/${id}/`, data, {
            /*headers: {
              headers,
            },*/
          })
            ...
            <DialogTitle>
                <div style={{display:'flex'}}>
                    <Typography
                        ...
                        style={{flexGrow:1}}
                    >
                        Modifier plan entretien garage
                    </Typography>
                    <Button
                        color={'secondary'}
                        text={'X'}
...
export default EditPlanEntretienGarage