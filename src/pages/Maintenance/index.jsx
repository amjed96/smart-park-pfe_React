...
function Maintenance() {
    ...
    return (
        <Container>
            ...
            <TableCont>
                <caption>Liste des demandes d'intervention</caption><br/>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><span className='curative'>curative</span></td>
                        <td>Diagnostique moteur</td>
                        <td><span className='etat dispo'>Traitée</span></td>
                    ...
                    <tr>
                        ...
                        <td>01/04/2022</td>
                        <td><span className='matricule'>120TUN5320</span></td>
                        <td><span className='preventive'>préventive</span></td>
                        <td>Révision</td>
                        <td><span className='etat cloturee'>Clôturée</span></td>
                    ...
                    <tr>
                        ...
                        <td><span className='etat occupe'>En cours</span></td>
            ...
            <AjoutDemande trigger={btnPopup} setTrigger={setBtnPopup} />
        </Container>
    );
  }
