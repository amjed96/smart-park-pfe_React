...
import AjoutPlanEntretienGarage from '../../components/AddPlanEntretienGarageForm';
import EditPlanEntretienGarage from '../../components/AddPlanEntretienGarageForm/edit';
...
function PlansInterventionGarage() {
    ...
    const retrieveAllData = () => {
        axios
            .get(`${baseURL}/plan-entretien-garage/`, {
            /*headers: {
                headers,
            },*/
            })
    ...
    const deleteData = (id) => {
        axios
            .delete(`${baseURL}/plan-entretien-garage/${id}/`, {
                /*headers: {
                    headers,
                },*/
            })
    ...
    return (
        <Container>
            ...
            <AjoutPlanEntretienGarage open={open} setOpen={setOpen} />
            <EditPlanEntretienGarage openedit={openedit} setOpenedit={setOpenedit} id={id} />
        </Container>
    );
}

export default PlansInterventionGarage