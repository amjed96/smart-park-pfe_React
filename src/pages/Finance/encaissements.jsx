            ...
            {/*<TableCont>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>EN001235</td>
                        <td>15-04-2022</td>
                        <td><span className={'echeance'}>15-10-2022</span></td>
                        <td><span className={'green'}>Versement</span></td>
                        <td>Mohamed Ben Mohamed</td>
                        <td>12.000 D.T</td>
                        <td><span className={'green'}>En cours</span></td>
                    ...
                    <tr>
                        ...
                        <td>15-04-2022</td>
                        <td><span className={'echeance'}>15-10-2022</span></td>
                        <td><span className={'blue'}>Chèque</span></td>
                        <td>Mohamed Ben Mohamed</td>
                        <td>12.000 D.T</td>
                        <td><span className={'red'}>Clôturée</span></td>
                        <td><Link to={`${url}/${id}`}><FontAwesomeIcon icon={ faArrowUpRightFromSquare } className='details-icon'/></Link></td>
                        <td className='action-btns'>
                            <ActionButtonEdit>
                                <FontAwesomeIcon onClick={() => setBtnPopup(true)} icon={ faPenToSquare } className='btn btn-edit' />
